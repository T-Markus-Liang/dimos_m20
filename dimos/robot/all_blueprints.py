...
all_blueprints = {
    ...
    "orin-sense-headless": "dimos.hardware.platforms.orin_nx.blueprints:orin_sense_headless",
...
all_modules = {
    ...
    "ros2-sensor-bridge": "dimos.hardware.sensors.ros2_bridge.ROS2SensorBridge",
    "ros2-twist-connection": "dimos.hardware.drive_trains.ros2_twist.ROS2TwistConnection",
